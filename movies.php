...
<html>
	<head>
		...
		<script src="modules/article-viewer/record-loader.js" type="text/javascript"></script>
		<script>var subject = "Movies";</script>
		<script>var view = "sub";</script>
	</head>
	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				<?php include('/home4/fauxgeek/www/dev//home4/fauxgeek/www/dev/includes/lower-boxes.php'); ?>
			</div>
			<hr>
