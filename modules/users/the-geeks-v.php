		...
		<div class="row-fluid">
			<div class="span12" id="article-listing">
				<div class="row-fluid">
					...
					<div class="span9">
						<h4><a href="the-geeks.php?num=<?php echo $record['num'] ?>"><?php echo htmlencode($record['username']) ?><a href="the-geeks.php?num=<?php echo $record['num'] ?>"></a></h4>
						<p>
							<strong><?php echo htmlencode($record['title']) ?><br /></strong>
							<?php echo htmlencode($record['email']) ?>
						</p>
						Recent Articles:
						<ul class="recent-articles">
							<?php foreach($articlesByUser[$record['username']] as $art): ?>
								<li><a href="article-viewer.php?num=<?php echo $art['num'] ?>"><?php echo $art['title'] ?></a></li>
							<?php endforeach ?>
						</ul>
					</div>
